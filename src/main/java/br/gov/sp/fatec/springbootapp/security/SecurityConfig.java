...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    /**
     * Configurando como o spring faz autenticação (Login) Estou dizendo para o
     * spring que toda vez que for fazer login deverá usar o serviço
     ...
     * Autowire. Usanos isso no lugar do @Service porque esta classe não é do
